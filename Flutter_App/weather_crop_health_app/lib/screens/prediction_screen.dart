  ...
  Widget build(BuildContext context) {
    return ValueListenableBuilder<String>(
      ...
      builder: (context, currentLang, _) {
        final translatedCrop = LanguageService().getCropName(prediction.crop);
        final translatedLocation = LanguageService().getLocationName(prediction.location);
        ...
        return Scaffold(
          ...
          appBar: AppBar(
            title: Text(
              LanguageService().t(
                en: "$translatedCrop Health Analysis",
                hi: "$translatedCrop स्वास्थ्य विश्लेषण",
                ur: "$translatedCrop صحت کا تجزیہ",
              ),
            ),
          ),
